...
class Artist(models.Model):
    ...
    private_email = models.CharField('Contact Email (private)', blank=True, max_length=100)
    private_phone = models.CharField('Contact Phone (private)', blank=True, max_length=100)

    # Tracking fields
    creation_date = models.DateTimeField(default=timezone.now)
    creation_user = models.ForeignKey(User, on_delete=models.SET_NULL, related_name='artist_creation_user', null=True)
